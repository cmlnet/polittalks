...
# Daten
data <- read.csv("datensaetze/geschlechterverhaeltnis_sendungen.csv", dec = ",", stringsAsFactors=TRUE, na.strings = "0.000000")
# Entferne 0%-Anteile
...
# Speichern als
## PNG
ggsave("grafiken/plot_geschlechterverhaeltnis_sendungen.png", plot, type="cairo", dpi = "retina")
## PDF
ggsave("grafiken/plot_geschlechterverhaeltnis_sendungen.pdf", plot, device=cairo_pdf, dpi = 600)
## SVG
ggsave("grafiken/plot_geschlechterverhaeltnis_sendungen.svg", plot)
